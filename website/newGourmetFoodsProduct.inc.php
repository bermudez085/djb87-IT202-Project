...
<form name="newitem" action="index.php" method="post">
   <table cellpadding="1" border="0">
       <tr>
           <td>Product ID:</td>
           <td><input type="text" name="GourmetFoodsProductID" size="4" required></td>
       </tr>
       <tr>
           <td>Product Code:</td>
           <td><input type="text" name="GourmetFoodsProductCode" size="20" required></td>
       </tr>
       <tr>
           <td>Name:</td>
           <td><input type="text" name="GourmetFoodsProductName" size="20" required></td>
       </tr>
       <tr>
           <td>Category ID:</td>
       ...
       <tr>
           <td>Description:</td>
           <td><input type="text" name="GourmetFoodsdescription" size="10" required></td>
       </tr>
       <tr>
           <td>List Price:</td>
           <td><input type="text" name="GourmetFoodsListPrice" size="10" required></td>
       </tr>
       <tr>
           <td>Description:</td>
           <td><input type="text" name="GourmetFoodsdescription" size="10" required></td>
       ...
       <tr>
           ...
           <td><input type="text" name="GourmetFoods_WholesalePrice" size="10" required></td>
       </tr>
       <tr>
           <td>Out Of Stock:</td>
